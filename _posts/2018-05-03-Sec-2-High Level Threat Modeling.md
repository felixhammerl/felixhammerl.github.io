...
Consider the following estimation you might come across in boardrooms: `Vulnerability * Probability * Impact = Risk`. By far the most pervasive anti-patterns regarding threat modeling is using magic-quadrants, made-up severity ratings, applying some formulae, and serving it spiced up with *cyber*, *zero-day*, and *botnet*, all while ignoring the larger business context. Let me be absolutely clear: There is nothing *best* about these so-called best practices. This stems from a [calculus of negligence](https://en.wikipedia.org/wiki/Calculus_of_negligence), as illustrated by the movie [Fight Club](http://www.imdb.com/title/tt0137523/):
